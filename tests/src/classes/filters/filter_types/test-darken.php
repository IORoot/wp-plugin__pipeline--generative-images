...
/**
 * @testdox Testing the \genimage\filters\darken class
 */
class filterDarkenTest extends WP_UnitTestCase
{
    public function setUp()
    {
        parent::setUp();
        $this->class_instance = new \genimage\filters\darken;
    }
    ...
    public function test_output_with_no_params()
    {
         ...
         */
        $expected = '<rect height="100%" width="100%" x="0" y="0" fill-opacity="1" fill="#000000"></rect>';
    ...
    public function test_output_with_a_float_param()
    {
         ...
         * Expected, Recieved, Asserted
         */
        $expected = '<rect height="100%" width="100%" x="0" y="0" fill-opacity="0.5" fill="#000000"></rect>';
        $recieved = $this->class_instance->output();
        $this->assertEquals($expected, $recieved);
    }
