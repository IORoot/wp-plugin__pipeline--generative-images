...
/**
 * @testdox Testing the \genimage\filters\image class
 */
class filterImageTest extends WP_UnitTestCase
{
    public function setUp()
    {
        parent::setUp();
        $this->class_instance = new \genimage\filters\image;
    }
     ...
     *
     */
    public function test_output_creates_an_image_tag()
    {
        /**
         * SETUP
         */
        $this->class_instance->set_params(serialize('filter="url(#myFilter)"'));
         ...
         */
        $expected = '<image  xlink:href="/var/www/vhosts/dev.londonparkour.com/wp-content/plugins/andyp_pipeline_generative_images/tests/data/test_image.jpg" width="1920" height="1080" filter="url(#myFilter)"></image>';
     ...
     * @test
     *
     * @testdox Testing filter returns false output() without reference image.
     *
     */
    public function test_output_fails_on_no_image_input()
    {
        /**
         * SETUP
         */
     ...
     * @test
     *
     * @testdox Testing filter returns output() without extra params.
     *
     */
    public function test_output_returns_image_without_extra_params()
    {
        /**
         * SETUP
         */
         ...
         * Expected, Recieved, Asserted
         */
        $expected = '<image  xlink:href="/var/www/vhosts/dev.londonparkour.com/wp-content/plugins/andyp_pipeline_generative_images/tests/data/test_image.jpg" width="1920" height="1080" ></image>';
        $recieved = $this->class_instance->output();
        $this->assertEquals($expected, $recieved);
    }
