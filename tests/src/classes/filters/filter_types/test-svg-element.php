...
/**
 * @testdox Testing the \genimage\filters\svg_element class
 */
class filterSvgElementTest extends WP_UnitTestCase
{
    public function setUp()
    {
        parent::setUp();
        $this->class_instance = new \genimage\filters\svg_element;
    }
     ...
     * @test
     *
     * @testdox Testing filter can output().
     *
     */
     ...
     *
     */
    public function test_output_params()
    {
        /**
         * SETUP
         */
